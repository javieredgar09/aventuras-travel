...
?>
<div id="modal-itinerary" class="modal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.4);align-items:center;justify-content:center;z-index:1000">
  <div class="modal-card" style="width:860px;background:#fff;border-radius:12px;padding:18px">
    ...
    <form id="form-itinerary">
      ...
      <textarea name="detalle_json" id="detalle_json" style="width:100%;height:320px;padding:12px;border:1px solid #e6f2f1;border-radius:8px;font-family:monospace;"><?= htmlspecialchars($itDetalle) ?></textarea>
